...
gohai collects system facts through 65 pluggable collectors across 9
categories. Each collector gathers a specific category of information and
returns a strongly-typed Go struct.
